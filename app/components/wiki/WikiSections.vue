<template>
  <!-- Section bodies shared by /wiki (hub) and /wiki/:section. -->
  <!-- Pass section="<id>" for a single section, "all" is unused by routes. -->
  <div class="wiki-sections" :class="{ 'single-section': section !== 'all' }">
    <article v-if="section === 'why-qxchat-exists'" id="why-qxchat-exists" class="doc-chapter">
                <div class="chapter-header">
                  <h2>Why QxChat exists</h2>
                  <NuxtLink to="/wiki/why-qxchat-exists" class="heading-anchor" aria-label="Permalink to Why QxChat exists">#</NuxtLink>
                </div>
    ...
    <article v-if="section === 'how-it-works'" id="how-it-works" class="doc-chapter">
                <div class="chapter-header">
                  <h2>How it works</h2>
                  <NuxtLink to="/wiki/how-it-works" class="heading-anchor" aria-label="Permalink to How it works">#</NuxtLink>
                </div>
    ...
    <article v-if="section === 'the-technology'" id="the-technology" class="doc-chapter">
                <div class="chapter-header">
                  <h2>The technology</h2>
                  <NuxtLink to="/wiki/the-technology" class="heading-anchor" aria-label="Permalink to The technology">#</NuxtLink>
                </div>
    ...
    <article v-if="section === 'open-source'" id="open-source" class="doc-chapter">
                <div class="chapter-header">
                  <h2>Open source, always</h2>
                  <NuxtLink to="/wiki/open-source" class="heading-anchor" aria-label="Permalink to Open source, always">#</NuxtLink>
                </div>
    ...
    <article v-if="section === 'join-community'" id="join-community" class="doc-chapter">
                <div class="chapter-header">
                  <h2>Join the community</h2>
                  <NuxtLink to="/wiki/join-community" class="heading-anchor" aria-label="Permalink to Join the community">#</NuxtLink>
                </div>
    ...
    <article v-if="section === 'architecture'" id="architecture" class="doc-chapter">
                <div class="chapter-header">
                  <h2>Architecture</h2>
                  <NuxtLink to="/wiki/architecture" class="heading-anchor" aria-label="Permalink to Architecture">#</NuxtLink>
                </div>
    ...
    <article v-if="section === 'authentication'" id="authentication" class="doc-chapter">
                <div class="chapter-header">
                  <h2>Account Authentication</h2>
                  <NuxtLink to="/wiki/authentication" class="heading-anchor" aria-label="Permalink to Account Authentication">#</NuxtLink>
                </div>
    ...
    <article v-if="section === 'signature-protocol'" id="signature-protocol" class="doc-chapter">
                <div class="chapter-header">
                  <h2>Client Signature Protocol</h2>
                  <NuxtLink to="/wiki/signature-protocol" class="heading-anchor" aria-label="Permalink to Client Signature Protocol">#</NuxtLink>
                </div>
    ...
    <article v-if="section === 'message-transport'" id="message-transport" class="doc-chapter">
                <div class="chapter-header">
                  <h2>Message Transport</h2>
                  <NuxtLink to="/wiki/message-transport" class="heading-anchor" aria-label="Permalink to Message Transport">#</NuxtLink>
                </div>
    ...
    <article v-if="section === 'phantom-protocol'" id="phantom-protocol" class="doc-chapter">
                <div class="chapter-header">
                  <h2>QXP-PHANTOM Protocol</h2>
                  <NuxtLink to="/wiki/phantom-protocol" class="heading-anchor" aria-label="Permalink to QXP-PHANTOM Protocol">#</NuxtLink>
                </div>
    ...
    <article v-if="section === 'crypto-primitives'" id="crypto-primitives" class="doc-chapter">
                <div class="chapter-header">
                  <h2>Cryptographic Primitives</h2>
                  <NuxtLink to="/wiki/crypto-primitives" class="heading-anchor" aria-label="Permalink to Cryptographic Primitives">#</NuxtLink>
                </div>
    ...
    <article v-if="section === 'anti-abuse'" id="anti-abuse" class="doc-chapter">
                <div class="chapter-header">
                  <h2>Anti-Abuse</h2>
                  <NuxtLink to="/wiki/anti-abuse" class="heading-anchor" aria-label="Permalink to Anti-Abuse">#</NuxtLink>
                </div>
    ...
    <article v-if="section === 'protocol-changes'" id="protocol-changes" class="doc-chapter">
                <div class="chapter-header">
                  ...
                  <NuxtLink to="/wiki/protocol-changes" class="heading-anchor" aria-label="Permalink to Changelog & Gap Report">#</NuxtLink>
                </div>
